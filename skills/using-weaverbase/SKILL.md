...
description: Use when creating or modifying code, reviewing changes, or choosing architecture, validation, Python contracts, Python logging, language, platform, database, Docker, or testing patterns
---
...
- Code review for architecture, validation, language, platform, database, Docker, or testing conventions
...
A FastAPI endpoint validates at the boundary, delegates to reusable business logic, and maps domain errors in the interface layer:
